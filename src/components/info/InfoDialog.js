            ...
            case 0:
                contents.push(
                    <div>
                        ...
                        <Typography key={'child2'}>{txt.igalod.funding}</Typography>
                    </div>
                );
                break;
            case 1:
                ...
                contents.push(
                    ...
                    <List component='div'>
                        <ListItem className={classes.item} disableGutters>
                            ...
                            <Typography className={classes.text2} style={{ marginTop: 16 }}>{txt.infoDialog.selection}</Typography><br></br>
                        </ListItem>
                        <ListItem className={classes.item} disableGutters>
                ...
                return (
                    <div>
                        ...
                        >
                            ...
                            <DialogActions>
                                <Button onClick={() => { this.props.toggleInfo() }} color="primary">{txt.button.close}</Button>
                            </DialogActions>
                        </Dialog>
                    </div>
                )
